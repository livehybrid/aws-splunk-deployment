...
The Kubernetes half of the SOK deployment: the EKS cluster, managed node groups, gp3 StorageClasses and pinned addons. Torn down and rebuilt by the SOK start/stop workflows.
...
| [kubernetes_config_map_v1.node_local_dns](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/config_map_v1) | resource |
| [kubernetes_daemon_set_v1.node_local_dns](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/daemon_set_v1) | resource |
| [kubernetes_service_account_v1.node_local_dns](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/service_account_v1) | resource |
| [kubernetes_service_v1.kube_dns_upstream](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/service_v1) | resource |
| [kubernetes_storage_class_v1.splunk_gp3](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/storage_class_v1) | resource |
...
| <a name="output_cluster_name"></a> [cluster\_name](#output\_cluster\_name) | Consumed by the sok layer via terraform\_remote\_state (key eks/terraform.tfstate). |
| <a name="output_kubeconfig_command"></a> [kubeconfig\_command](#output\_kubeconfig\_command) | n/a |
| <a name="output_namespace"></a> [namespace](#output\_namespace) | Namespace holding the operator and all Splunk CRs. |
| <a name="output_node_group_autoscaling_group_names"></a> [node\_group\_autoscaling\_group\_names](#output\_node\_group\_autoscaling\_group\_names) | ASG names created by the EKS managed node groups (one per group). |
| <a name="output_node_security_group_id"></a> [node\_security\_group\_id](#output\_node\_security\_group\_id) | n/a |
| <a name="output_oidc_provider"></a> [oidc\_provider](#output\_oidc\_provider) | OIDC issuer URL (no scheme), IRSA trust-policy conditions key off this. |
